...
reported to the project maintainers through GitHub — by opening an issue if the
matter is not sensitive, or by using GitHub's private reporting on the
repository if it is. All complaints will be reviewed and investigated promptly
and fairly.
